...
import com.syk.sykmm.api.ApiSeivice;
import com.syk.sykmm.api.CheckNetworkStatus;
import com.syk.sykmm.api.ConnectionManager;
import com.syk.sykmm.api.ResultListener;

public class Search extends BaseFragment implements ResultListener, ActivityResultCallback<ActivityResult> {

    public static int id;
    private final List<HashMap<String, Object>> date = new ArrayList<>();
...
//        TextView txt_error = findViewById(R.id.check);
    ...
    public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.Holder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull Search.SearchAdapter.Holder holder, @SuppressLint("RecyclerView") int position) {
